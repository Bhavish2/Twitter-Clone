...
function createPostHtml(postData,largeFont=false)
{
  ...
  var postedky=postData.postedBy;



  if(postedky._id===undefined)
  {
    return console.log("user object not populated")
  }

  var displayName=postedky.firstname+" "+postedky.lastname;
  ...
  if(postData.replyTo && postData.replyTo._id){
    ...
    <a href='/profile/${replyTousername}'>@${replyTousername}</a> </div>`
  }
  ...
  <div class='postActionContainer'>
    ...
    <div class='mainContentContainer'>
      <div class='userImageContainer'>
        <img src='${postedky.ProfilePic}'>
      </div>
      <div class='postContentContainer'>
        <div class='header'>
        <a href='/profile/${postedky.username}' class='displayname'>${displayName}</a>
        <span class='username'>${postedky.username}</span>
